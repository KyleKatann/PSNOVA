...
- On individual weapon detail pages, the weapon search/filter toolbar scrolls normally with the page and must not be sticky. The table header may remain vertically sticky for comparison, but no table column may be fixed or horizontally sticky.
